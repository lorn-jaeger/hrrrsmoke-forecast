...
gribcheck --config "$CFG" build-wildfire-raster-dataset --workers "$WORKERS" --sample-hours-utc 0,6,12,18 --next-day-only --daily-aggregate --resume --checkpoint-flush-samples 1
